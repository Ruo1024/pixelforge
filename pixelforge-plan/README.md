...
> 本文档包面向负责开发的 AI 与工程师。当前产品路线已于 2026-07-12 重基线：旧 M0–M7 统一归入 Beta 0.1 工程历史，Beta 0.2 已工程收口；当前主线是 Beta 0.3–0.5 图像向无限画布原型冲刺。
...
2. 当前总路线：`03-milestones/BETA-0.3-0.5-ROADMAP.md`，再读正在执行的 Beta 计划；
...
│   ├── BETA-0.3-0.5-ROADMAP.md   # 当前原型冲刺总路线
...
1. **任务卡是边界，不是停顿点**：当前一个 Goal 连续完成 Beta 0.3–0.5，不在单卡、集成切片或版本出口停下请求用户。
2. **契约即法律**：发现契约缺口时提出最小修订；未获批准不得静默造第二套格式或语义。
3. **自动化持续运行**：卡内跑定向测试，整体切片合流时跑全量门禁；自动化红灯不得继续扩张。
4. **自动化开发、最终人工**：Beta 0.3–0.5 开发期间完全不使用 Computer Use，只运行自动化和脚本截图；三版完成后由项目所有者统一人工验收。
