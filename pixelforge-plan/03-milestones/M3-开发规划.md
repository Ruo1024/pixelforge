...
M3 通过只代表内部工作台原型达到出口，不代表受邀 alpha 或公开发布。当前 G-4 系列收口并完成对应人工签收后，除修复上述出口阻断项外，不再追加节点便利性小卡；下一张主线卡固定为 `M3.1-alpha-readiness.md`。UX-4 保持 `NOT-PASSED` 并登记设计债，本轮不重做 LOD。
