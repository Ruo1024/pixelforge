...
- M6: add the palette-constrained pixel repair editor, frame-layer documents, drawing/repair tools, animation timeline, tags, and canvas/batch round-trip editing.
